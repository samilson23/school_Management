...
urlpatterns = [
    ...
    path('update_student_units/<str:id>', hod_views.update_student_units,name="update_student_units"),
    ...
    path('check_subject_code',hod_views.check_subject_code,name="check_subject_code"),
    ...
    path('save_update_student_units',hod_views.save_update_student_units,name="save_update_student_units"),
    path('get_unregistered_student_units',hod_views.get_unregistered_student_units,name="get_unregistered_student_units"),
    ...
    path('clear_all_staff',staffviews.clear_all_staff,name="clear_all_staff"),
    path('clear_one_staff',staffviews.clear_one_staff,name="clear_one_staff"),
    ...
    path('clear_all',student_views.clear_all,name="clear_all"),
    path('clear_one',student_views.clear_one,name="clear_one"),
    ...
    path('delete_stage',hod_views.delete_stage,name="delete_stage"),
    ...
    path('semester_registration',student_views.semester_registration,name="semester_registration"),
    # path('staff_update_attendance', staffviews.staff_update_attendance, name="staff_update_attendance"),
    ...
    path('edit_dept_save',admin_views.edit_dept_save,name="edit_dept_save"),
    ...
    path('edit_school/<int:id>',admin_views.edit_school,name="edit_school"),
    path('edit_dept/<int:id>',admin_views.edit_dept,name="edit_dept"),
    ...
    path('edit_school_save',admin_views.edit_school_save,name="edit_school_save"),
